...
var ContentImage = function (_React$Component) {
    _inherits(ContentImage, _React$Component);

    function ContentImage(props) {
        _classCallCheck(this, ContentImage);

        var _this = _possibleConstructorReturn(this, (ContentImage.__proto__ || Object.getPrototypeOf(ContentImage)).call(this, props));

        _this.state = {
            list: false
        };
        _this.onListClick = _this.onListClick.bind(_this);
        return _this;
    }
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement('span', { className: 'dot', style: { background: '#ED594A' } }),
                            _react2.default.createElement('span', { className: 'dot', style: { background: '#FDD800' } }),
                            _react2.default.createElement('span', { className: 'dot', style: { background: '#5AC05A' } })
                        ),
                        _react2.default.createElement(
                            'div',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'bar-list', style: { float: 'right' }, onClick: this.onListClick },
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement('img', { className: 'image', src: data.image_location }),
                            _react2.default.createElement(
                                'div',
                                { className: 'image-overlay', style: list },
                                _react2.default.createElement(
                                    'div',
...
var ContentImagesRow = function (_React$Component2) {
    _inherits(ContentImagesRow, _React$Component2);

    function ContentImagesRow(props) {
        _classCallCheck(this, ContentImagesRow);

        return _possibleConstructorReturn(this, (ContentImagesRow.__proto__ || Object.getPrototypeOf(ContentImagesRow)).call(this, props));
    }

    _createClass(ContentImagesRow, [{
        key: 'render',
        value: function render() {
            var row = [];
            var sortType = "";
            ...
            this.props.data.map(function (data) {
                if (sortType === "all") {
                    row.push(_react2.default.createElement(ContentImage, { data: data, key: row.length++ }));
                }
    ...
    return ContentImagesRow;
}(_react2.default.Component);

var FilterableImages = function (_React$Component3) {
    _inherits(FilterableImages, _React$Component3);

    function FilterableImages(props) {
        _classCallCheck(this, FilterableImages);

        var _this3 = _possibleConstructorReturn(this, (FilterableImages.__proto__ || Object.getPrototypeOf(FilterableImages)).call(this, props));

        _this3.state = {
            portfolioData: _this3.props.portfolioData,
            all: true,
            node: false,
            react: false,
            javascript: false
        };
        _this3.onClickAll = _this3.onClickAll.bind(_this3);
        _this3.onClickNode = _this3.onClickNode.bind(_this3);
        _this3.onClickReact = _this3.onClickReact.bind(_this3);
        _this3.onClickJavascript = _this3.onClickJavascript.bind(_this3);
        return _this3;
    }

    _createClass(FilterableImages, [{
        key: 'onClickAll',
        value: function onClickAll() {
            if (!this.state.all) {
                this.setState({
                    all: true,
                    node: false,
        ...
        key: 'onClickJavascript',
        value: function onClickJavascript() {
        ...
        key: 'render',
        value: function render() {
            var all = this.state.all ? "button sort-selected" : "button";
            var node = this.state.node ? "button sort-selected" : "button";
            var react = this.state.react ? "button sort-selected" : "button";
            var javascript = this.state.javascript ? "button sort-selected" : "button";
            return _react2.default.createElement(
                'div',
                { className: 'sort-image-container' },
                _react2.default.createElement(
                    'div',
                    { className: 'tab' },
                    _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        {
                            ...
                            onClick: this.onClickJavascript },
                        'JAVASCRIPT'
                    )
                ),
                _react2.default.createElement(ContentImagesRow, {
...
_reactDom2.default.render(_react2.default.createElement(FilterableImages, { portfolioData: portfolioData }), document.getElementById('app'));
